// Package log - пакет с функциями для логирования
package log
...
func New(logFile string) error {
	...
	f, err := os.OpenFile(logFile, os.O_APPEND|os.O_CREATE|os.O_WRONLY, permissions) //nolint:gosec
	if err != nil {
		return err
	}
...
// Infof - пишет информационный лог
func Infof(v ...any) {
